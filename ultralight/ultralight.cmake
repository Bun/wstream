...
MACRO(ultralight_prepare target)
...
MACRO(ultralight_after target)
    # Copy all binaries to target directory
    add_custom_command(TARGET ${target} POST_BUILD
        COMMAND ${CMAKE_COMMAND} -E copy_directory "${ULTRALIGHT_BINARY_DIR}" $<TARGET_FILE_DIR:${target}>)
    ...
    if (APPLE)
        set(RESOURCES_PATH "$<TARGET_FILE_DIR:${target}>/../Resources/resources")
    else ()
        set(RESOURCES_PATH "$<TARGET_FILE_DIR:${target}>/resources")
    endif ()
    ...
    add_dependencies(${target} UltralightSDK)
ENDMACRO()
